...
$(function(){
	...
	var $bridalParty = $('#about-us');

	$bridalParty
		.on('click', function(){
    		lazyLoad('#about-us');
    		bgLazyLoad('.groomsmen', '#about-us');
    		bgLazyLoad('.bridesmaides', '#about-us');
    	})
		.on('click', '.cover-left a', function(e){
			e.preventDefault();
			$('.bridesmaides', $bridalParty).show();
			$('.groomsmen', $bridalParty).hide();
			$('.icn-about-us', $bridalParty).animate({ bottom: '-140px' }, ANIMATION_SPEED, function(){
		...
		.on('click', '.icn-back', function(e){
			...
			$('.icn-back', $bridalParty).animate({ bottom: '-120px' }, ANIMATION_SPEED, function(){
				$(this).animate({ bottom: '-226px' }, ANIMATION_SPEED, function(){
					...
					$('.icn-about-us', $bridalParty).animate({ bottom: '-150px' }, ANIMATION_SPEED, function(){
